                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select class="chosen form-control" name="branchID">
                                                    <option value="#">Choose Branch</option>
                                                        <?php while($branch = mysqli_fetch_array($brc)){ ?>
                                                            <option value="<?php echo $branch['branchID']?>" ><?php echo $branch['Branch_Name']?></option>
                                                        <?php }?>
                                                    </select>
                                            </div>
                                            <div class="form-group col-md-3">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="number" name="prize" class="form-control" placeholder="₱ " value="<?php echo $show_ivent['price']?>" required>
                                            </div>
                                            <div class="form-group col-md-2">
