                                    ...
                                    <table id="example" class="display" style="min-width: 100%">
                                        ...
                                        <tbody>
                                            <?php while($administratorss = mysqli_fetch_array($inv)){ ?>
                                                ...
                                                <td><a href="check-profile.php?profile=<?php echo $administratorss['usersID']?>"><i class="fi fi-rr-user btn btn-primary"></i></a><a href="inventory-admin.php?disrole=<?php echo $administratorss['staffID']?>"><i class="fi fi-rr-replace btn btn-secondary"></i></a></td>
                                            </tr>
                                            <?php }?>
