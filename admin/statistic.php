                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h4 class="card-title">General Monthly Amount of Year : <?php echo $transayear ?> <form action="" method="post"><input type="number" name="yearc" min="2023" placeholder="Year" max="2099" id=""> <button type="submit" style="background-color: var( --primary-color); color : white;" name="shoyear">Show</button></form></h4>  <h4 class="card-title"><a href="yearstatistic.php" class="btn" style="background-color: var( --primary-color); color : white;">Show Statistic Yearly</a></h4> 
                            </div>
                            <div class="card-body">
