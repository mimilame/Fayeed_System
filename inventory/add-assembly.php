                    ...
                    <div class="col-xl-12 col-xxl-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php if(isset($edit['assemblyName'])){ echo "Update Assembly <b>".$edit['assemblyName']."'s</b> Details";}else{echo "Add New Assembly";} ?></h4> <a href="assemblylist.php" class="btn btn-primary">Back</a>
                            </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" name="quanty" class="form-control" min="1" max="5" <?php if(isset($edit['assemblyQuatty'])){ ?> value="<?php echo $edit['assemblyQuatty']?>" <?php }else{ ?> value="1" <?php }?> required>
                                            </div>
                                            
                                        <button type="submit" name="assembly" class="btn btn-primary"><?php if(isset($edit['assemblyName'])){ echo "Update Assembly Details";}else{echo "Create Assembly inventory";} ?></button>
                                    </form>
                                </div>
                            </div>
                        </div>
